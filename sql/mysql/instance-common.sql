...
UPDATE INST_JKS.CAM_COMMONFUNCTION  SET FUNCTIONTYPE = 0;
-- 复制列
UPDATE INST_JKS.CAM_COMMONFUNCTION SET FUNCTIONID = UNUSED_FUNCTIONID;

-- 音视频会议

SELECT HEX(T.RECID),T.* FROM PINSTANCE.CAM_AVMEETINGINFO T;
